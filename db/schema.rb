...
ActiveRecord::Schema.define(version: 20170331191124) do
  ...
  create_table "user_weeks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_user_weeks_on_user_id", using: :btree
    t.index ["week_id"], name: "index_user_weeks_on_week_id", using: :btree
  end
